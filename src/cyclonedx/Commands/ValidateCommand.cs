...
namespace CycloneDX.Cli.Commands
{
    public static class ValidateCommand
    {
        ...
        public static void Configure(RootCommand rootCommand)
        {
            ...
            subCommand.Add(new Option<SpecificationVersion?>("--input-version", "Specify input file specification version (defaults to v1.7)"));
        ...
        public static async Task<int> Validate(ValidateCommandOptions options)
        {
            ...
            {
                validationResult = Xml.Validator.Validate(inputBom, SpecificationVersion.v1_7);
